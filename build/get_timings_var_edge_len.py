...
while str_len <= 64:
    ...
    for i in range(0,100):
        ...
        '''
        if(i<99):
            with open('/home/dtkhuat/results/random_graphs_compressed/IndexedEdges_compressed/'+ researched_path+'/timings.csv', 'a') as csv_file:
               #csv_writer = csv.writer(csv_file, delimiter=',')
                csv_file.write(", ")
                csv_file.close()
